      ...
      <div className="grid md:grid-cols-5 gap-8 max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="card p-6 hover:shadow-neon transition-all duration-300">
            <div className="text-sm text-white/60 uppercase tracking-wider mb-4">Connect With Us</div>
            <div className="flex flex-col gap-3">
              <a 
                href={SOCIALS.linkedin} 
                className="flex items-center gap-2 text-white/80 hover:text-blue-400 transition-colors group/link"
                target="_blank" 
                rel="noreferrer"
              >
                <span className="text-sm font-medium group-hover/link:translate-x-1 transition-transform">LinkedIn</span>
              </a>
              <a 
                href={SOCIALS.instagram} 
                className="flex items-center gap-2 text-white/80 hover:text-pink-400 transition-colors group/link"
                target="_blank" 
                rel="noreferrer"
              >
                <span className="text-sm font-medium group-hover/link:translate-x-1 transition-transform">Instagram</span>
              </a>
              <a 
                href={SOCIALS.github} 
                className="flex items-center gap-2 text-white/80 hover:text-purple-400 transition-colors group/link"
                target="_blank" 
                rel="noreferrer"
              >
                <span className="text-sm font-medium group-hover/link:translate-x-1 transition-transform">GitHub</span>
              </a>
            </div>
          </div>
        </motion.div>
